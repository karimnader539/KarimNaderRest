...
namespace KarimNaderRest.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public List<string> GetEmpById(string id)
        {
            ...
            string connectionString = "Data Source=DESKTOP-QCFGV7V;Initial Catalog=AdventureWorks2019;User ID=sa;Password=P@ssw0rd; Integrated Security=true";
